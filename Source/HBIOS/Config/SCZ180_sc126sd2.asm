;
;==================================================================================================
;   ROMWBW BUILD SETTINGS FOR SC126 WITH 2 SDCARDS
;==================================================================================================
;
...
;
CPUOSC		.SET	18432000	; CPU OSC FREQ IN HZ
;
Z180_CLKDIV	.SET	1		; Z180: CLK DIV: 0=OSC/2, 1=OSC, 2=OSC*2
...
TMSMODE		.SET	TMSMODE_MSX	; TMS: DRIVER MODE: TMSMODE_[SCG|N8|MSX|MSXKBD|MSXMKY|MBC|COLECO|DUO|NABU|MSXUKY|MECB]
...
SDMODE		.SET	SDMODE_SC	; SD: DRIVER MODE: SDMODE_[JUHA|N8|CSIO|PPI|UART|DSD|MK4|SC|MT|USR|ZPIO|GPIO|Z80R|EPITX|T35|GM|EZ512|K80W]
